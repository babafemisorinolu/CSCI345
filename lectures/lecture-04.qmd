---
title: "Lecture 4: Classification Metrics" 
author: "Babafemi Sorinolu (Slides adapted from Varada Kolhatkar)"
...
Which prediction produces the **largest** log loss?
...
For this demo, each student should [click this link](https://github.com/new?template_name=lecture09_demo&template_owner=ubc-cpsc330) to create a new repo in their accounts, then clone that repo locally to follow along with the demo from today.
